...
sealed class Screen(val route: String) {
    ...
    object Profile : Screen("profile?showSettings={showSettings}") {
        fun createRoute(showSettings: Boolean = false) = "profile?showSettings=$showSettings"
    }
    ...
    // Profildeki "Arkadaşlar" sayacına dokununca açılan, kabul edilmiş
    // arkadaşlıkların düz listesi (bkz. ProfileScreen -> FriendsListScreen).
    ...
    // Rüya dikey kaydırma ekranı (TikTok/Reels tarzı)
    object DreamReels : Screen("dream_reels")
