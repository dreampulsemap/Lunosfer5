...
mapping = {
    "dream.addTitle": "dream_addTitle",
    "dream.placeholder": "dream_placeholder",
    "dream.location": "dream_location",
    "dream.public": "dream_public",
    "dream.friends": "dream_friends",
    "dream.private": "dream_private",
    "dream.shareInFeed": "dream_shareInFeed",
    "dream.submit": "dream_submit",
    "dream.validationContent": "dream_validationContent",
    "dream.createFailed": "dream_createFailed",
    "location.unknown": "dream_unknownLocation",
    
    "emotion.joy": "dream_emotion_joy",
    "emotion.peace": "dream_emotion_peace",
    "emotion.love": "dream_emotion_love",
    "emotion.hope": "dream_emotion_hope",
    "emotion.awe": "dream_emotion_awe",
    "emotion.surprise": "dream_emotion_surprise",
    "emotion.curiosity": "dream_emotion_curiosity",
    "emotion.confusion": "dream_emotion_confusion",
    "emotion.fear": "dream_emotion_fear",
    "emotion.anxiety": "dream_emotion_anxiety",
    "emotion.sadness": "dream_emotion_sadness",
    "emotion.loneliness": "dream_emotion_loneliness",
    "emotion.anger": "dream_emotion_anger",
    "emotion.shame": "dream_emotion_shame",
    "emotion.disgust": "dream_emotion_disgust",
    "emotion.relief": "dream_emotion_relief"
}
...
for lang, folder in lang_to_folder.items():
    xml_file = os.path.join(res_dir, folder, "strings.xml")
    if os.path.exists(xml_file):
        tree = ET.parse(xml_file)
        root = tree.getroot()
        
        # Remove existing dream_ to prevent duplicates
        for child in list(root):
            if child.attrib.get('name', '').startswith('dream_'):
                root.remove(child)
                
        strings = data.get(lang)
        if not strings:
            strings = data["en"] # fallback
            
        for js_key, xml_key in mapping.items():
            val = strings.get(js_key, data["en"].get(js_key, ""))
            # Create element
            el = ET.SubElement(root, "string", name=xml_key)
